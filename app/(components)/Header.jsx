    ...
    <div className="pt-14 md:pt-28 text-center">
      ...
      <div className="inline-block">
        <div className="md:flex md:space-x-4 mt-10 space-y-4 md:space-y-0">
          ...
          <div className="text-white bg-emerald-600 hover:bg-emerald-700 transition-all duration-300 shadow-2xl py-1 px-3 md:py-2 md:px-6 font-semibold md:font-bold text-base md:text-lg rounded-md cursor-pointer">
            Create Account
          </div>
        </div>
      </div>
